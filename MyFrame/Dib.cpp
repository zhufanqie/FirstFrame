...
::StretchBlt(hDC, lpDCRect->left, lpDCRect->top, hSrcDC,GetRectWidth(lpDCRect),GetRectHeight(lpDCRect),         
		0, 0,GetRectWidth(lpDIBRect),GetRectHeight(lpDIBRect),+SRCCOPY);
*/
